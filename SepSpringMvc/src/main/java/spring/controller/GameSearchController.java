...
public class GameSearchController {
	...
	//메서드에 @ModelAttribute 어노테이션을 적용한 경우, 이 메서드가 먼저 실행된다.
	//이 메서드의 return 값이 모델 데이터에 추가된다.
	//그 다음엔 @RequestMapping 어노테이션이 붙어있는 메서드가 실행된다.
	...
	public ModelAndView search(@ModelAttribute("command") SearchCommand command) {
		//ModelAndView 생성자 첫 번째 매개변수는 view name
